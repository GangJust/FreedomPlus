...
public val IconRes.Freedom: ImageVector
    get() {
        if (_freedom != null) {
            return _freedom!!
        }
        _freedom = Builder(name = "Freedom", defaultWidth = 209.0.dp, defaultHeight = 211.0.dp,
                viewportWidth = 209.0f, viewportHeight = 211.0f).apply {
...
private var _freedom: ImageVector? = null
